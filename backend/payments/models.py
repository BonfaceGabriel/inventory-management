...
class CombinedOrder(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # BFIX: Also don't auto-fulfill if PARTIALLY_FULFILLED, as this blocks completion
        ...
        if (self.amount_fulfilled >= self.total_amount
            and self.status not in [self.Status.FULFILLED, self.Status.IN_PROGRESS, self.Status.PARTIALLY_FULFILLED]):
...
# ============================================================================
# Generated Reports (persisted daily exports)
# ============================================================================

class GeneratedReport(models.Model):
    """
    Persisted daily report generated by the Celery beat task at end-of-day.
    The download endpoint serves this cached copy for past dates and falls
    back to on-the-fly generation for today or missing rows.
    """
    ...
    def __str__(self):
        return f"Report for {self.report_date} (generated {self.generated_at})"