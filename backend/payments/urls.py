...
from .views import (
    ...
    merchandise_create_order_for_transaction,
...
urlpatterns = [
    ...
    path('merchandise/orders/transaction/<int:transaction_id>/', merchandise_create_order_for_transaction, name='merchandise-create-order-for-transaction'),
